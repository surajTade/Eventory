...
const EventCard = ({
  ...
  return (
    <div
      className={`relative border-2 shadow-md w-[22rem] h-[28rem] rounded-lg p-2 text-center ${bgLines} bg-[size:24px_24px]`}
    >
      ...
      <p className="text-xs mt-2 w-[80%] mx-auto">{description}</p>
